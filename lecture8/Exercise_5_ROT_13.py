"""
Exercise 5  http://greenteapress.com/thinkpython2/html/thinkpython2009.html
...
def spline(char, n):
    ...
    n = n%26
    res = alphabet[alphabet.find(char)+n]
    if flag:
        return res.upper()
    else:
        return res
...
def ROT_N(word, n):
    return ''.join(spline(letter, n) for letter in word)
